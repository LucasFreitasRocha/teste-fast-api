...
from src.controller import app_controller, auth_controller, company_controller, user_app_controller
...
api_router.include_router(auth_controller.router, prefix="", tags=["auth"])